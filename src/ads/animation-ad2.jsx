...
export default class AnimationAd2 extends React.Component {
  ...
  componentDidMount () {
    ...
    const ballHeadConfiguration = (index) => {
      return {
    ...
    return (
      <section className="animation-ad">
        ...
        <div className="animation-ad-container">
          ...
          <div className="animation-canvas">
            <div className="ball-container ball-head ball-head-0 orange" />
            <div className="ball-container ball-head ball-head-1 orange" />
            <div className="ball-container ball-head ball-head-2 orange" />
            <div className="ball-container ball-head ball-head-3 orange" />
          </div>
